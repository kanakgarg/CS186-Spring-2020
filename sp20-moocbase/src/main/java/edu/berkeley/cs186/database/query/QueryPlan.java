...
public class QueryPlan {
    ...
    public Iterator<Record> execute() {
        ...
        Map<Set, QueryOperator> newMap = pass1map;
    ...
    QueryOperator minCostSingleAccess(String table) {
        ...
        for (int index : getEligibleIndexColumns(table)){
            QueryOperator indOp = new IndexScanOperator(transaction, table, selectColumnNames.get(index),
        ...
        return addEligibleSelections(minOp, mIndex);
    }
